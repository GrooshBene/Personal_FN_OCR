...
/* flash-store version 0.6.6 */
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('brolog'), require('cuid'), require('state-switch'), require('path'), require('app-root-path'), require('rimraf'), require('encoding-down'), require('nosql-leveldb'), require('levelup')) :
        typeof define === 'function' && define.amd ? define(['exports', 'brolog', 'cuid', 'state-switch', 'path', 'app-root-path', 'rimraf', 'encoding-down', 'nosql-leveldb', 'levelup'], factory) :
            (factory((global.window = {}), global.brolog, global.cuid, global.stateSwitch, global.path, global.appRootPath, global.rimraf, global.encoding, global.LevelDb, global.levelup));
}(this, (function (exports, brolog, cuid, stateSwitch, path, appRootPath, rimraf, encoding, LevelDb, levelup) {
    'use strict';
    cuid = cuid && cuid.hasOwnProperty('default') ? cuid['default'] : cuid;
    rimraf = rimraf && rimraf.hasOwnProperty('default') ? rimraf['default'] : rimraf;
    encoding = encoding && encoding.hasOwnProperty('default') ? encoding['default'] : encoding;
    LevelDb = LevelDb && LevelDb.hasOwnProperty('default') ? LevelDb['default'] : LevelDb;
    levelup = levelup && levelup.hasOwnProperty('default') ? levelup['default'] : levelup;
    ...
    var FlashStore$1 = /** @class */ (function () {
        /**
        ...
        FlashStore$1.prototype.version = function () {
            return VERSION;
        };
        /**
         ...
         */
        FlashStore$1.prototype.put = function (key, value) {
        ...
        FlashStore$1.prototype.set = function (key, value) {
            return __awaiter$1(this, void 0, void 0, function () {
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
         ...
         */
        FlashStore$1.prototype.get = function (key) {
            return __awaiter$1(this, void 0, void 0, function () {
                var _d, _e, e_5;
         ...
         */
        FlashStore$1.prototype.del = function (key) {
            return __awaiter$1(this, void 0, void 0, function () {
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
        ...
        FlashStore$1.prototype.delete = function (key) {
            return __awaiter$1(this, void 0, void 0, function () {
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
         ...
         * }
         */
        FlashStore$1.prototype.keys = function (options) {
         ...
         * }
         */
        FlashStore$1.prototype.values = function (options) {
            if (options === void 0) { options = {}; }
         ...
         */
        FlashStore$1.prototype.count = function () {
            return __awaiter$1(this, void 0, void 0, function () {
                var size;
                return __generator(this, function (_d) {
                    switch (_d.label) {
        ...
        Object.defineProperty(FlashStore$1.prototype, "size", {
            get: function () {
                var _this = this;
                ...
                return new Promise(function (resolve, reject) { return __awaiter$1(_this, void 0, void 0, function () {
                    var e_3, _a, count, _b, _c, e_3_1_1, e_6;
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            case 0:
         ...
         */
        FlashStore$1.prototype.has = function (key) {
            return __awaiter$1(this, void 0, void 0, function () {
                var val;
                return __generator(this, function (_d) {
                    switch (_d.label) {
         ...
         */
        FlashStore$1.prototype.clear = function () {
            return __awaiter$1(this, void 0, void 0, function () {
                var e_4, _a, _b, _c, key, e_4_1_1;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
         ...
         * @private
         */
        FlashStore$1.prototype.entries = function (options) {
        ...
        FlashStore$1.prototype[Symbol.asyncIterator] = function () {
         ...
         * @private
         */
        FlashStore$1.prototype.streamAsyncIterator = function () {
        ...
        FlashStore$1.prototype.close = function () {
            return __awaiter$1(this, void 0, void 0, function () {
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
         ...
         * @returns {Promise<void>}
         */
        FlashStore$1.prototype.destroy = function () {
            return __awaiter$1(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_d) {
                    switch (_d.label) {
    ...
    exports.FlashStore = FlashStore$1;
    exports['default'] = FlashStore$1;
    exports.log = log;
