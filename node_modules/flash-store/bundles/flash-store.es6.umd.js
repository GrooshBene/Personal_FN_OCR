...
}(this, (function (exports,brolog,cuid,stateSwitch,path,appRootPath,rimraf,encoding,LevelDb,levelup) { 'use strict';
...
class FlashStore$1 {
     ...
     */
    constructor(workdir = path.join(appRootPath.path, '.flash-store')) {
