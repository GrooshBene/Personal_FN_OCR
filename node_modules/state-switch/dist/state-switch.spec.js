...
test('on()', (t) => __awaiter(this, void 0, void 0, function* () {
...
test('off()', (t) => __awaiter(this, void 0, void 0, function* () {
    const ss = new StateSwitch();
...
test('pending()', (t) => __awaiter(this, void 0, void 0, function* () {
    const ss = new StateSwitch();
...
test('name', (t) => __awaiter(this, void 0, void 0, function* () {
...
test('ready()', (t) => __awaiter(this, void 0, void 0, function* () {
    const spy = sinon.spy();
    const ss = new StateSwitch();
